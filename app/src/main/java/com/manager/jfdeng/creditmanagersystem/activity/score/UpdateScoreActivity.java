...
import com.manager.jfdeng.creditmanagersystem.activity.student.UpdateDetialActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.del:
                if(mStudent!=null)
                {
                    Intent intent = new Intent(UpdateScoreActivity.this,UpdateScoreDetialActivity.class);
